...
* From the Open File or Project window that appears, navigate to and select the 'ObjectDetectorTensorflow' directory from wherever you cloned the TensorFlow Lite sample GitHub repo. Click OK.
